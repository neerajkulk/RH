/* ------- file: -------------------------- formal.c ----------------
       ...
       Last modified: Fri May  1 10:16:54 2020 --
...
/* Function to calculate spherical tensors. Do 1 formal solution to get the intensities and do wavelength and frequency integration */
...
void write_spherical_tensor()
{
 ...
 bool_t   initialize, boundbound, polarized_as, polarized_c,
   PRD_angle_dep, to_obs, solveStokes, angle_dep;
 enum     FeautrierOrder F_order;
 int      Nspace = atmos.Nspace, Nrays = atmos.Nrays, nt,la,ni,nf,lamu;
